...
public final class Symphonys {
     ...
     * Logger.
     */
//    private static final Logger LOGGER = LoggerFactory.getLogger(Symphonys.class);
    public static final Logger LOGGER = LoggerFactory.getLogger(Symphonys.class);
    ...
    public static List<JSONObject> getSyms() {
        ...
        try {
            ...
            LOGGER.error( "Gets syms from Rhythm failed", e);
