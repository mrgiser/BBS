...
@Component
public class ArticleSearchAdder implements ApplicationListener<AddArticleEvent> {

    /**
     * Logger.
     */
    public static final Logger LOGGER = LoggerFactory.getLogger(ArticleSearchAdder.class);
