...
public class GobangChannel {
     ...
     * Logger.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(GobangChannel.class);
    ...
    public void onConnect(final Session session) {
        ...
        if (playing) {
            ...
            if (chessGame == null) {
                ...
                final ActivityMgmtService activityMgmtService = SpringUtil.getBean(ActivityMgmtService.class);
